  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="preload" as="image" href="/images/area.png" />
        <link rel="preload" as="image" href="/images/moleintrap.jpg" />
        <link rel="preload" as="image" href="/images/rat1.jpg" />
        <link rel="preload" as="image" href="/images/waspnest.jpg" />
        <link rel="preload" as="image" href="/images/moles_collage.jpg" />
        <link rel="preload" as="image" href="/images/farm_moles.jpg" />
        <link rel="preload" as="image" href="/images/farm_son.jpg" />
        <link rel="preload" as="image" href="/images/farm_john_mole.jpg" />
        <link rel="preload" as="image" href="/icons/facebook_logo.png" />
        <link rel="preload" as="image" href="/icons/Instagram_icon.png" />
        <link rel="preload" as="image" href="/icons/linked-in.jpg" />
        <link rel="preload" as="image" href="/icons/tube-icon.jpg" />
        {/* Favicon */}
